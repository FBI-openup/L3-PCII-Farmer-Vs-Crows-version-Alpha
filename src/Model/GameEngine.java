...
public class GameEngine {
    ...
    private void initializeGameUnits() {
        ...
        //addUnit(new FoodStorageCenter(new Point(450, 150), this));
    ...
    public int getScore() {
        ...
        if (sellingCenter != null) {
            return sellingCenter.getCornSold();
        }
        return 0;
    }
    ...
    // Increase the farmer's health
    public void increaseFarmerHealth(int health) {
        Farmer farmer = getFarmer();
        if (farmer != null) {
            farmer.setHealth(farmer.getHealth() + health);
        }
